<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.customers.create') }}" class="inline-flex items-center px-4 py-2 bg-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                Add Customer
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-app-card border border-app-border overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <table id="customers-table" class="min-w-full divide-y divide-app-border">
                        <thead>
                            <tr>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on('submit', '.delete-customer-form', function (event) {
