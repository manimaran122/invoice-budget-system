<x-app-layout>
    ...
    @php
        $statusClass = match ($salesInvoice->status) {
                        ...
                        <table class="min-w-full divide-y divide-app-border">
                            ...
                            <tbody class="divide-y divide-app-border">
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-right text-sm text-app-dark">{{ number_format($salesInvoice->subtotal, 2) }}</td>
                                    <td class="px-4 py-4 text-right text-sm text-app-dark">{{ number_format($salesInvoice->tax, 2) }}</td>
                                    <td class="px-4 py-4 text-right text-sm text-app-dark">{{ number_format($salesInvoice->discount, 2) }}</td>
                                    <td class="px-4 py-4 text-right text-sm font-semibold text-app-dark">{{ number_format($salesInvoice->total, 2) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
